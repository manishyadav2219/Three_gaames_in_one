...
import com.example.manishyadab.project.Animations.Circle;
import com.example.manishyadab.project.Animations.CircleAnim;
import com.example.manishyadab.project.Animations.Line;
import com.example.manishyadab.project.Animations.LineAnim;
import com.example.manishyadab.project.Animations.LineAnimReverse;

import java.util.Arrays;

public class TTTMain extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setLevel(level);        setCheck(true, false, false);
        ...
        color_light = 0xff3F51B5;
        color_dark =  0xff303F9F;
        stroke = 0xff000000;
    ...
    public void animateLine(Line line) {
        ...
        Animation animation = new LineAnim(liner, width, height);
        final Animation animation_r = new LineAnimReverse(liner, width, height);
    ...
    public void animateCircle(Circle circle){
        ...
        Animation animation = new CircleAnim(circle);
